...
var savedFormGroupEl = document.querySelector('#savedFormGroup');
...
var getSavedCities = function() {
    ...
    if (savedCities !== null) {
        ...
        var uniqueCities = new Set(cityList);
...
// event listener for saved cities click
savedFormGroupEl.addEventListener('click', savedCityFormSubmit);
        ...
        if (response.status !== 200) {
            ...
            response.json().then(function(data) {
                ...
                if (data.length === 0) {
                    ...
                    return fetch('https://api.openweathermap.org/data/2.5/onecall?lat='+ lat +'&lon='+ lon +'&units=imperial&exclude=minutely,hourly,alerts&appid=f63a069e27328750769e0a8925c0d4d8').then(function(response) {
                        response.json().then(function(data) {
                            console.log(data);
